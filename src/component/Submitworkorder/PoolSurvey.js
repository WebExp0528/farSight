  ...
  render() {
    ...
    return (
        ...
        <Form onSubmit={parent.submitSurvey} id="SurveyForm">
          ...
          <Form.Label>What day of the week are you completing the weekly pool service for this property?(DOES NOT EXIST)</Form.Label>
          <Form.Control
              as="select"
              id="Weekly_Service_Day__c"
              onChange={parent.updateAnswer}
            >
          <option>None</option>
