    ...
    return (
      <Card style={{ marginBottom: '0.5em' }}>
        <Card.Body style={{ padding: '0.25em' }}>
          ...
          <Card.Subtitle className="mb-2 text-muted">{this.state.error}</Card.Subtitle>
          If you are a registered user, a new authentication link has been sent to your email address on file. Please
          check your email and try again.
        </Card.Body>
        <Card.Footer style={{ padding: '0.5em', fontSize: '0.75em', textAlign: 'right' }}></Card.Footer>
      </Card>
    );
  }
  render() {
