...
// export const getDetails = (ItemId) => async dispatch => {
    
//     try{
//         const res = await axios.get(`https://cors-anywhere.herokuapp.com/http://dev.northsight.io/api/work_order/list`+ItemId,{
//             method: 'GET',
//             headers: {
//               'X-Requested-With': 'XMLHttpRequest',
//               "X-USER-ID": "00903200-EQ00-QUY1-UAA3-1EQUY1EQ1EQU",
